...
window.FABLED_FEATS_DEFAULT = [
  ...
  },
  {
    ...
    "req": "None",
    "boon": "Sharpened claws grow from your fingertips. As a single limited action, scrape the claws together, along metal, or upon Dragon Scales to produce a spray of sparks that ignite flammable objects and cause a -1 aim penalty to targets within a 3x3 area in front of you. This spray can be evaded or blocked as an Unarmed template. \nIf you instead use both actions, targets also take 1 AP/GP damage that increases each round on their turn (1 -> 2 -> 3) until they spend an action to extinguish themselves. \nWhen this ability is used with at least one action, Unarmed attacks on your next turn deal full base damage (4) as the claws glow red-hot.",
  ...
  },
  {
    ...
    "cat": "Spirit of the Fire Dragon",
    "req": "None",
    "boon": "Scaled wings similar to those of the beast grow from your back in dark or neutral hues of red, orange, black, and similar colors. While not allowing true flight, when falling you may react to slow your descent and mitigate fall damage completely. As a limited action, you can perform one of the following maneuvers so long as you are not grappled: \n-Flap: Dash 8m (8 blocks) in any direction (including vertical), ignoring movement penalties. \n-Repel: Your wings open wide, battering anyone within Melee distance blocks 4m (4 blocks) away from you unless they succeed on a DEX: Acrobatics or STR: Athletics check. \n-Stoke: Currents of air are directed to an open flame, encouraging it to grow 4 blocks in a horizontal direction of your choice. \nAdditionally, your oath to slay aberrations gives you an innate sixth sense. At DM discretion, you are alerted to the presence of aberrations in your vicinity.",
  ...
  },
  {
    ...
    "cat": "Equinox & Phoenix",
    "req": "None",
    "boon": "You gain the Dusk Mark. This manifests as a cool-hued mark on the body, such as a glowing tattoo or a steely ring around the iris. Each full day cycle, you may use Touch of the Phoenix or Equinox a number of times equal to the number of P&E feats you own. You gain access to the following effects to choose from, each costing and action and lasting for three rounds, with the exception of Repose: \n-Empower Soul: You and everyone within Skirmishing distance roll INT & HAR related checks with a +1 bonus, and STR & DEX related checks with a -1 penalty. \n-Nightfall: Your Dusk Mark swallows all light in the Ranged area around you, eclipsing it in darkness equivalent to nighttime. \n-Repose: You stabilize a willing target or one in Bleedout by making physical contact with them, placing them in a peaceful stasis where they cannot move or speak. Barring complete destruction of their body, they cannot be killed for the next complete day cycle unless the Equinox blessed is killed or removes the stasis effect.",
  ...
  },
  {
    ...
    "cat": "Equinox & Phoenix",
    "req": "None",
    "boon": "You gain the Phoenix Brand. This manifests as a warm-hued mark on the body, such as a glowing tattoo or a fiery ring around the iris. Each full day cycle, you may use Touch of the Phoenix or Equinox a number of times equal to the number of P&E feats you own. You gain access to the following effects to choose from, each costing an action and lasting for three rounds: \n-Empower Body: You and everyone within Skirmishing distance roll STR & DEX related checks with a +1 bonus, and INT & HAR related checks with a -1 penalty. \n-Daybreak: Your Phoenix Brand illuminates the Ranged area around you, flooding it with Daylight. \n-Invigorate: The base movement and dash speed you and your allies in Skirmishing distance are increased by +1. Uneven terrain no longer has a penalty, and attempts to traverse obstacles are made with a +3 modifier.",
